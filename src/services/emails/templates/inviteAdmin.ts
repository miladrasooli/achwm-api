      ...
      <mj-body background-color="#F3F2E7">
        <mj-section>
          <mj-column>
            ...
            <mj-text mj-class="medium">
             You have been invited to be an admin for the following ACHWM community: ${communityName}.
            </mj-text>
            <mj-text mj-class="medium">
             Once your invitation is accepted, you will be an administrator for all projects in this community.
            </mj-text>
            <mj-text mj-class="medium">
